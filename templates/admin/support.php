<?php
/**
 * Admin support dashboard for invitation projects.
 *
...
?>
<div class="pks-oi-admin-support">
	<?php settings_errors( 'pks_oi_admin' ); ?>
	...
	<p><a class="button" href="<?php echo esc_url( $my_account_url ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Open support view in My Account', 'prikogstreg-online-invitations' ); ?></a>
	<a class="button" href="<?php echo esc_url( $retry_import_url ); ?>"><?php esc_html_e( 'Retry import', 'prikogstreg-online-invitations' ); ?></a></p>

	<h4><?php esc_html_e( 'Support actions', 'prikogstreg-online-invitations' ); ?></h4>
